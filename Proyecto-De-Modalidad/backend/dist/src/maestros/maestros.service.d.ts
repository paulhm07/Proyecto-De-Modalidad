...
export declare class MaestrosService {
    ...
    actualizarSeccion(id: string, data: {
        nombre?: string;
        grado?: number;
        activa?: boolean;
        asignaturaId?: string | null;
    ...
    inscribirEstudiante(seccionId: string, estudianteId: string): Promise<{
        mensaje: string;
        inscripcion: {
            id: string;
            createdAt: Date;
    ...
    desinscribirEstudiante(seccionId: string, estudianteId: string): Promise<{
        mensaje: string;
    }>;
    obtenerEstudiantesDeSeccion(seccionId: string): Promise<{
        id: string;
        nombre: string;
        puntos: number;
        experiencia: number;
    ...
    actualizarTarea(id: string, data: {
        titulo?: string;
        descripcion?: string | null;
        fechaLimite?: string;
        estado?: string;
    ...
    registrarAsistenciaBatch(registros: {
        seccionId: string;
        estudianteId: string;
        fecha: string;
        estado: string;
    ...
    actualizarAsistencia(id: string, data: {
        estado?: string;
        observacion?: string | null;
    }): Promise<{
        id: string;
